...
#/software/team205/bin/jsub lsf -n cpdb -q normal -c 20 -m 150g "bash cpdb_run_pooleddisease18485genes_5pc_20230526.sh" | bsub -G teichlab
...
# must exist
OUTPUT_PATH=/nfs/team205/ao15/Megagut/Annotations_v3/disease_analysis/interactions_cellphoneDB/cpdb_output/pooled_disease_18485genes_5pc
